...
export default function CreatePostLayout(){
  ...
  const onSubmit = async (event) => { /* "event" instead of dealing with callbacks/promises */
    event.preventDefault();
    await axios.post(`${LOCAL.BASE}${LOCAL.POSTS_PORT}/posts`, {title});
  ...
  return (
    ...
    <div>
      <div>
        <h1>
          Hello, welcome to this blog example
        </h1>
      </div>
      <form onSubmit={onSubmit}>
        ...
        <div className="form-group">
          ...
          <input 
            ...
            type="text" id="input_title" className="form-control"
